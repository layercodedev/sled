...
class ExampleAgent implements acp.Agent {
  ...
  async initialize(_: acp.InitializeRequest): Promise<acp.InitializeResponse> {
    return {
  ...
  async newSession(_: acp.NewSessionRequest): Promise<acp.NewSessionResponse> {
  ...
  async authenticate(_: acp.AuthenticateRequest): Promise<acp.AuthenticateResponse | void> {
    // No auth needed - return empty response
    return {};
  }

  async setSessionMode(_: acp.SetSessionModeRequest): Promise<acp.SetSessionModeResponse> {
