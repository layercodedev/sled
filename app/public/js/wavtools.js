    ...
    _start() {
      ...
      streamNode.port.onmessage = (e) => {
        ...
        if (event === "stop") {
          ...
          if (typeof this.onPlaybackStop === "function") {
            this.onPlaybackStop();
          }
...
`;
  ...
  var WavRecorder = class {
    ...
    async requestPermission() {
      ...
      try {
        // Check if Permissions API is supported and works for microphone
        ...
        // Safari throws on navigator.permissions.query({ name: "microphone" })
        // Fall through to request permission directly
      ...
      if (permissionState === "denied") {
        ...
        // For Safari and when permission state is unknown, try to get media directly
        try {
