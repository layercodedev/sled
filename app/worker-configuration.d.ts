/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 14203fbc51171f5f7855ff74e2dc95cd)
// Runtime types generated with workerd@1.20251011.0 2025-09-19 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ClaudeContainer";
	}
	interface Env {
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_KEY: string;
		INWORLD_API_KEY: string;
		ANTHOPIC_API_KEY: string;
		DEBUG_LOG: string;
		CLAUDE_CONTAINER: DurableObjectNamespace<import("./src/index").ClaudeContainer>;
		DB: D1Database;
		AI: Ai;
	}
}
